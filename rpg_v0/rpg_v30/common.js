...
function room_tw() {//방정보출력
        ...
        room_fld.value = cha_location.info();
}
...
function aggro_chk() { //방의 적대 몬스터 체크
        ...
        for (let [divid, monster] of cha_location.mob) {
                ...
                if (monster.aggression == 'H'){
                    inBattle = true; 
                    div.style.border = "2px solid #8f1717";   
                    div.style.backgroundColor = "#f5bcbc";   
                }
                else if(monster.aggression == 'F'){
                        div.style.border = "2px solid #19963c";
                        div.style.backgroundColor = "#a1e7a4";
                }
        }
